...
const Button = ({label, color, className}) => {
    return (
        <button style={{ borderColor: color }} className={`
            flex items-center border-[1.5px] xl:border-[2px] rounded-full group
            ...
            text-[0.9rem] sm:text-[1.1rem] lg:text-[0.9rem] xl:text-[1rem] 2xl:text-[1.1rem]  ${className ?? ''}
        `}>
            {label}
            <FaCircleChevronRight className="
                text-[1.2rem] sm:text-[1.4rem] lg:text-[1.3rem] xl:text-[1.4rem] 2xl:text-[1.5rem]
                ml-[0.6rem]
